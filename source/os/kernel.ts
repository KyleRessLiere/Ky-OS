...
module TSOS {
    ...
    export class Kernel {
        ...
        public krnBootstrap() {      // Page 8. {
            Control.hostLog("bootstrap", "host");  // Use hostLog be use we ALWAYS want this, even if _Trace is off.
            ...
            this.krnTrace(_krnKeyboardDriver.status);
             ...
             _diskDriver = new DeviceDriverDisk();     // Construct it.
             _diskDriver.driverEntry();                    // Call the driverEntry() initialization routine.
             this.krnTrace(_diskDriver.status);

              // Memory Manger
            _MemoryManager = new MemoryManager(); // Construct

            _Scheduler = new Scheduler(); // Construct
